...
- `schema.sql`만 실행해본 경우: `migration_v2.sql` → `migration_v3.sql` → `migration_v4.sql` → `migration_v5.sql` → `migration_v6.sql` → `migration_v7.sql`
- `migration_v6.sql`까지 실행한 경우: `migration_v7.sql`만
